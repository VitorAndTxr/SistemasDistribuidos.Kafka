...
class ObserverBroker:
    def __init__(self, broker_id):
        ...
        self.leader = None
        print(f"Observer broker {broker_id} initialized.")
    ...
    def promote_to_voter(self):
        with self.lock:
            ...
            print(f"Observer {self.broker_id} promoted to voter.")
    ...
    def start(self):
        ...
        self.leader.register_broker(self.broker_id, uri.asString(), 'Observer')
        print(f"Observer broker {self.broker_id} is running.")
        daemon.requestLoop()
